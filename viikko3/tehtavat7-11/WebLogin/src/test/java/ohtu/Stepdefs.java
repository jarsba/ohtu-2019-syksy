...
public class Stepdefs {
    ...
    public void userWithBadUsernameOrPasswordIsCreated(String username, String password) {
        registerNewUserWith(username, password, password);
    ...
    public void validUsernameAndPasswordNotMatchingConfirmationAreGiven(String username, String password, String passwordConfirmation) {
