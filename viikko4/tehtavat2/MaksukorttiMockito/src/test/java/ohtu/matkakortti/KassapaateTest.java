...
public class KassapaateTest {
    ...
    public void kortilleLadataanJosSummaPositiivinen() {
        ...
        kassa.lataa(kortti, ladattavaArvo);

        verify(kortti, times(1)).lataa(ladattavaArvo);
        verify(kortti).lataa(eq(ladattavaArvo));
    }
    ...
    public void kortilleEiLadataJosSummaNegatiivinen() {
        ...
        verify(kortti, times(0)).lataa(ladattavaArvo);
    }
